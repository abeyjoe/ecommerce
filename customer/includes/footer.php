<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				180-182 Regent Street, Nigeria.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:09024056004">0902-405-6004</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:abeyjoe18@gmail.com" class="email__addr">support@yourwebsite.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2025 Avenue Fashion&trade;
			</div>

			<div class="developer">
				Developed by <a href="https://abeyjoe.netlify.app" target="_blank">Abeyjoe</a>
			</div>
		</div>
	</div>
</footer>
